...
- [ ] 1. Cài Claude Code (bootstrap) — `04-claude-code-install_human.md` 🧑
- [ ] 2. Cấu hình WSL nền tảng — `00-wsl-base-config.md`
- [ ] 3. Restart WSL để nhận `wsl.conf` — `00b-wsl-restart_human.md` 🧑
- [ ] 4. Cập nhật hệ thống & gói nền — `01-system-update-base-packages.md`
- [ ] 5. Git (cấu hình dùng chung) — `02-git-setup.md`
- [ ] 6. Node.js 24.18 qua nvm — `03-nodejs-nvm.md`
- [ ] 7. PHP 8.3 + Composer — `05-php83-composer.md`
- [ ] 8. MySQL 8.4 — `06-mysql84.md`
- [ ] 9. Redis — `07-redis.md`
- [ ] 10. Apache (mod_php) — `08-apache-modphp.md`
- [ ] 11. HTTPS mkcert — phần WSL — `09-https-mkcert-wsl.md`
- [ ] 12. HTTPS mkcert — tin cậy CA trên Windows — `09b-https-mkcert-trust-windows_human.md` 🧑
- [ ] 13. Cấu hình Xdebug 3 — `10-xdebug-config.md`
- [ ] 14. Adminer — `11-adminer.md`
- [ ] 15. SSH server — phần WSL — `12-ssh-server-wsl.md`
- [ ] 16. Docker Engine (optional) — `13-docker-optional.md`
- [ ] 17. Scaffold dự án monorepo — `14-project-scaffold-structure.md`
- [ ] 18. VSCode Remote - WSL — `15-vscode-remote-wsl_human.md` 🧑
- [ ] 19. Backend — package `Acme.App` — `17-1-backend-scaffold-acme-app.md`
- [ ] 20. Frontend — mount Vue vào thẻ gốc — `17-2-frontend-vue-mount.md`
- [ ] 21. Chạy Vite dev server — `17-3-run-vite-dev-server.md`
- [ ] 22. Kiểm chứng `/api/health` — `17-4-verify-backend-health.md`
...
- [ ] 25. Docker + service Go — kiểm chứng — `17-8-verify-docker-go-service.md`
...
- [ ] 28. Export WSL — `19-export-wsl_human.md` 🧑
